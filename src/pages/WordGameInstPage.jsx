...
export default function wordGameInstPage() {
  ...
  return (
    <div className="inner-container">
      ...
      <h5>איך משחקים?</h5>
      <p>
      נציג מהמקריאים אומר בקול את המילה הכתובה על המסך (שימו לב- המטרה שהשומעים ישמעו את המילה גם בלי שתצעקו!). קבוצת השומעים תשלח נציג לבמה שיאמר את המילה ששמעו. בכל שלב החליפו נציגים.
במידה והשומעים הצליחו לשמוע את המילה הנכונה- סמנו מילה נכונה. במידה ולא- סמנו טעות ונסו שוב.
      </p>
